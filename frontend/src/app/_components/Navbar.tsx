      ...
      <div className="container mx-auto flex items-center justify-between">
        ...
        {!isMobile && (
          <div className="hidden md:flex items-center space-x-6">
            <Link
              href="/shop"
              className="text-black flex items-center space-x-1 font-satoshi-regular"
            >
              Shop
              <ChevronDown size={16} />
            </Link>
      ...
      {isMobile && isSearchOpen && (
        <div className="mt-4 px-4 py-2 bg-white border-t">
          <div className="relative">
            ...
            />
            <Search
              className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-600 font-satoshi-regular"
              size={18}
            />
          </div>
        </div>
